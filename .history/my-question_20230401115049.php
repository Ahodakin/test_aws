          ...
          <div class="columns is-desktop card-body">
            <!-- <div class="column is-4-desktop">
              <div class="post-slider slider-sm">
                <img src="assets/images/post/post-10.jpg" class="card-img" alt="post-thumb" style="height:200px; object-fit: cover;">
              </div>
            </div> -->
            <div class="column is-8-desktop">
              ...
              <a href="article.php" class="btn btn-outline-primary">Accéder à la question</a>
              <a href="edit-question.php" class="btn btn-outline-primary">Modifier la question</a>
              <a href="" class="btn btn-outline-primary">Supprimer la question</a>
            </div>
          </div>
        </article>
