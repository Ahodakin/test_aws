        ...
        <article class="card mb-5">
          <div class="columns is-desktop card-body">
            ...
            <div class="column is-8-desktop">
              ...
              <a href="post-elements.html" class="btn btn-outline-primary">Edit</a>
              <a href="post-elements.html" class="btn btn-outline-primary">Modifier</a>
              <a href="post-elements.html" class="btn btn-outline-primary">Supprimer</a>
            </div>
          </div>
        </article>
