    ...
    ?>
          ...
          <div class="columns is-desktop card-body">
            ...
            <div class="column is-8-desktop">
              <h3 class="h4 mb-3"><a class="post-title" href="article.php?id="></a></h3>

              <p><?php echo $question["description"]; ?></p>
              s="btn btn-outline-primary" href="action/questions/deleteQuestionAction.php?id=<?php echo $question["id"]; ?>" onclick="return confirm('Voulez-vous supprimer?');">Supprimer </a>
            </div>
          </div>
        </article>
			    </div>
