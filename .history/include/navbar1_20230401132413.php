    ...
    <div class="container">
      ...
      <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start mx-auto">
          ...
          <!-- <li class="navbar-item">
            <a class="navbar-link is-arrowless" href="my-question.php">Mon Profil</a>
          </li>
          <li class="navbar-item">
            <a class="navbar-link is-arrowless" href="my-question.php">Déconnexion</a>
          </li> -->

        </div>
        <div class="navbar-end is-align-items-center ml-0" d-grid gap-2>
            <a href="login.php"> <button class="btn btn-outline-primary  d-md-flex " type="button">Login</button></a> 
