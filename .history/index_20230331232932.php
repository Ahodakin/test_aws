...
<html lang="en-us"><head>
  ...
  <!-- theme meta -->
  <meta name="theme-name" content="reader-bulma" />

  <!-- plugins -->
  
  <link rel="stylesheet" href="assets/plugins/bulma/bulma.min.css">
  <link rel="stylesheet" href="assets/plugins/themify-icons/themify-icons.css">
  <link rel="stylesheet" href="assets/plugins/slick/slick.css">

  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="assets/css/style.css" media="screen">
  <!-- <link rel="stylesheet" href="https://assets3.lottiefiles.com/packages/lf20_q8ND1A8ibK.json" > -->
    ...
    <div class="container">
      <div class="navbar-brand">
        <a class="navbar-item" href="index.html">
          <img class="img-fluid" width="100px" src="theme/images/logo.png" alt="Reader | Personal Bulma Blog Template">
        </a>
      ...
      <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start mx-auto">
          ...
          <li class="navbar-item">
            <a class="navbar-link is-arrowless" href="contact.html">Les questions</a>
          </li>
          <li class="navbar-item">
            <a class="navbar-link is-arrowless" href="contact.html">Publier une question</a>
          </li>
          <li class="navbar-item">
            <a class="navbar-link is-arrowless" href="contact.html">Mes questions</a>
          </li>
...
<section class="section-sm">
  ...
  <div class="post-slider">
      <img src="theme/images/post/post-10.jpg" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      ...
      <li class="list-inline-item">
          ...
          <img src="theme/images/john-doe.jpg" alt="John Doe">
          <span>John Doe</span>
          </a>
      </li>
      <li class="list-inline-item">
